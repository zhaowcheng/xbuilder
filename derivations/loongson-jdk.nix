...
let
  ...
  sourcePerArch = {
    loongarch64 = {
      url = "https://ftp.loongnix.cn/Java/openjdk21/loongson21.7.15-fx-jdk21.0.7_6-linux-loongarch64-glibc2.34.tar.gz";
      version = "21.7.5";
      sha256 = "d8db6c41e0f8041ec4ccba944a377d68aff370db61952b15a793a950086d4021";
    };
    packageType = "jdk";
    vmType = "hotspot";
  };
